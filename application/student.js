module.exports = (dependencies) => ({
	getStudents: (id) => {
		if (id) {
			...
			if (existStudent === false) {
				return dependencies.helpers.makeReturn(404, { message: 'Student not found' })
			}
		}
	...
	createStudent: (student) => {
		...
		if (validStudent === false) {
			return dependencies.helpers.makeReturn(400, { message: 'Student is not valid'})
		}
	...
	updateStudent: (id, student) => {
		...
		const data = dependencies.infrastructure.studentRepository.updateStudent(id, student)
